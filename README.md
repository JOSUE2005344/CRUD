...
|----------------|---------------------|------------------------------------------------------------------------------------------------------------------|
| Scrum Master   | Gian Luca    | Facilita el proceso Scrum, elimina impedimentos y asegura que el equipo siga los principios ágiles.              |
| Product Owner  | Gianluca Revilla     | Define Historias de usuario, prioriza funcionalidades y establece las metas del proyecto.                        |
| Developer 1    | fabbian Espinoza       | Desarrolla la estructura de las plantillas HTML para la interfaz de usuario.                                     |
| Developer 2    | Mattias Muguruza     | Diseña y desarrolla el estilo CSS personalizados en la carpeta static/css.                                     |
...
| Developer 4    | Rodrigo Guerra  | Encargado de los test, funcionamiento correcto de la aplicación   |
| Developer 5    | Muguruza y Sicha  | Pair programing, Trabajo conjunto   |
